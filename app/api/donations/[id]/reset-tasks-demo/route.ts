...
export async function POST(
  ...
  try {
    ...
    const tasksToCreate = [
      // Task 1: Donor Sign NDA (COMPLETED for demo)
      {
      ...
      // Task 2: NonProfit Sign NDA (COMPLETED for demo)
      {
        ...
        completedAt: new Date(),
        completedBy: donationData.nonprofitAdminId,
        metadata: {
          documentPath: '/public/nda-general.pdf',
          documentName: 'General NDA',
          envelopeId: 'demo-envelope-2',
          signedAt: new Date().toISOString(),
          signingUrl: null,
          automatedReminders: true
        },
      ...
      // Task 3: Donor Invite Appraiser (COMPLETED for demo)
      {
      ...
      // Task 4: Appraiser Sign NDA (COMPLETED for demo)
      {
      ...
      // Task 5: Donor Upload Company Information (READY for demo - first active task)
      {
